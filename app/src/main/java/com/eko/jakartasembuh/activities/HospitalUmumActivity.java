package com.eko.jakartasembuh.activities;
...
import com.eko.jakartasembuh.R;
import com.eko.jakartasembuh.adapter.HospitalUmumAdapter;
import com.eko.jakartasembuh.model.ModelRumahSakit;
...
public class HospitalUmumActivity extends AppCompatActivity implements HospitalUmumAdapter.onSelectData {

    RecyclerView recyclerView;
    HospitalUmumAdapter hospitalAdapter;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < jsonArray1.length(); i++) {
                                ...
                                dataApi.setNamaRs(jsonObject1.getString("nama_rsu"));
                                dataApi.setJenisRs(jsonObject1.getString("jenis_rsu"));
                            ...
                            e.printStackTrace();
                            Toast.makeText(HospitalUmumActivity.this,
    ...
    private void showRumahSakit() {
        hospitalAdapter = new HospitalUmumAdapter(HospitalUmumActivity.this, modelRumahSakitList, this);
        recyclerView.setAdapter(hospitalAdapter);
    }

    @Override
    public void onSelected(ModelRumahSakit modelRumahSakit) {
        Intent intent = new Intent(HospitalUmumActivity.this, DetailHospitalActivity.class);
        intent.putExtra("rsDetail", modelRumahSakit);
        startActivity(intent);
    }
